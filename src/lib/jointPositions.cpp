...
void jointPositions::update_traceTraj(int tick_fL, int tick_fR, int tick_bL, int tick_bR)
{
#ifdef ENABLE_FRONT_LEFT
    ...
    joint_pos_target_deg.fL_hip_pos = LEG_LEFT_POS_MULTIPLIER * jtraj_hip_pos[tick_fL];
    joint_vel_target_deg.fL_hip_velo = LEG_LEFT_POS_MULTIPLIER * jtraj_hip_velo[tick_fL];
    joint_pos_target_deg.fL_knee_pos = LEG_LEFT_POS_MULTIPLIER * jtraj_knee_pos[tick_fL];
    joint_vel_target_deg.fL_knee_velo = LEG_LEFT_POS_MULTIPLIER * jtraj_knee_velo[tick_fL];
#endif
#ifdef ENABLE_FRONT_RIGHT
    ...
    joint_pos_target_deg.fR_hip_pos = LEG_RIGHT_POS_MULTIPLIER * jtraj_hip_pos[tick_fR];
    joint_vel_target_deg.fR_hip_velo = LEG_RIGHT_POS_MULTIPLIER * jtraj_hip_velo[tick_fR];
    joint_pos_target_deg.fR_knee_pos = LEG_RIGHT_POS_MULTIPLIER * jtraj_knee_pos[tick_fR];
    joint_vel_target_deg.fR_knee_velo = LEG_RIGHT_POS_MULTIPLIER * jtraj_knee_velo[tick_fR];
#endif
#ifdef ENABLE_BACK_LEFT
    ...
    joint_pos_target_deg.bL_hip_pos = LEG_LEFT_POS_MULTIPLIER * jtraj_hip_pos[tick_bL];
    joint_vel_target_deg.bL_hip_velo = LEG_LEFT_POS_MULTIPLIER * jtraj_hip_velo[tick_bL];
    joint_pos_target_deg.bL_knee_pos = LEG_LEFT_POS_MULTIPLIER * jtraj_knee_pos[tick_bL];
    joint_vel_target_deg.bL_knee_velo = LEG_LEFT_POS_MULTIPLIER * jtraj_knee_velo[tick_bL];
#endif
#ifdef ENABLE_BACK_RIGHT
    ...
    joint_pos_target_deg.bR_hip_pos = LEG_RIGHT_POS_MULTIPLIER * jtraj_hip_pos[tick_bR];
    joint_vel_target_deg.bR_hip_velo = LEG_RIGHT_POS_MULTIPLIER * jtraj_hip_velo[tick_bR];
    joint_pos_target_deg.bR_knee_pos = LEG_RIGHT_POS_MULTIPLIER * jtraj_knee_pos[tick_bR];
    joint_vel_target_deg.bR_knee_velo = LEG_RIGHT_POS_MULTIPLIER * jtraj_knee_velo[tick_bR];
#endif
}