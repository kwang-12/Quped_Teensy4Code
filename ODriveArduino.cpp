...
void ODriveArduino::readEncoderData(int axis_num){
    if (axis_num == 2){     //axis_num unspecified
        serial_ << "e" << '\n';                 //request pos&velo from both axes
